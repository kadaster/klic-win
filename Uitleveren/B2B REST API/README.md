...
|-----------------------------------------------------------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| De aanvraag is aangenomen, maar de verwerking/productie is nog niet gestart | **Productie**:<br>Dit is hetzelfde object als ingestuurd via de GIA-POST-API, aangevuld met: `giAanvraagId`, `positienummer` (in geval van tracé meldingen reeds door aanvrager opgegeven),  `aanvraagDatum`, `mutatieDatum`, `giAanvraagStatus`.<br>`ordernummer` en `klicMeldnummer` worden in dit scenario niet getoond. <br>De `giAanvraagStatus` is in dit geval "https://api.klic.kadaster.nl/waardelijsten/v2/giAanvraagStatussen/giAangenomen"<br><br>**Testomgeving**:<br>Voor testdoeleinden is er voor alle responses een vast `klicMeldnummer` (`99G7654321`) en een vast `ordernummer` (`9876543210`) toegevoegd. | **Productie**:<br>Http code 404 - "not found". <br>De gegevens zijn (nog) niet beschikbaar.<br><br>**Testomgeving**:<br>Een vast antwoord, met fictieve waarden:<br>`{`<br>&nbsp;`   "_links": {`<br>&nbsp;&nbsp;&nbsp;`        "self": {`<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;`            "href": "https://service10.kadaster.nl/klic/ntd/aanvragen/v1/gebiedsinformatieleveringen?giAanvraagId=8c775638-e108-46d4-9a67-d3632a0a35e3"`<br>&nbsp;&nbsp;&nbsp;`       }`<br>&nbsp;`    },`<br>`    "gebiedsinformatieLeveringen": [`<br>&nbsp;`       {`<br>&nbsp;&nbsp;&nbsp;            `"giAanvraagId": "8c775638-e108-46d4-9a67-d3632a0a35e3",`<br>&nbsp;&nbsp;&nbsp; `            "leveringsvolgnummer": 2,`<br>&nbsp;&nbsp;&nbsp; `            "isVeiligheidsgebiedGeraakt": false,`<br>&nbsp;&nbsp;&nbsp; `            "datumLeveringSamengesteld": "2024-03-29T03:34:18+01:00",`<br>&nbsp;&nbsp;&nbsp; `            "indicatieLeveringCompleet": true,`<br>&nbsp;&nbsp;&nbsp; `            "giLeveringUrl": "https://service10.kadaster.nl/gds2/download/public/5f6dc579-3cac-4724-9d1a-afa19a990d1d"`<br>&nbsp;`        },`<br>&nbsp;`        {`<br>&nbsp;&nbsp;&nbsp;`            "giAanvraagId": "8c775638-e108-46d4-9a67-d3632a0a35e3",`<br>&nbsp;&nbsp;&nbsp;`            "leveringsvolgnummer": 1,`<br>&nbsp;&nbsp;&nbsp;`            "isVeiligheidsgebiedGeraakt": false,`<br>&nbsp;&nbsp;&nbsp;`            "datumLeveringSamengesteld": "2024-03-29T03:04:18+01:00",`<br>&nbsp;&nbsp;&nbsp;`            "indicatieLeveringCompleet": false,`<br>&nbsp;&nbsp;&nbsp;`            "giLeveringUrl": "https://service10.kadaster.nl/gds2/download/public/a84e0a4f-d647-44be-87d2-8762243cf720"`<br>&nbsp;`        }`<br>`}`<br> |
|                                                                             |                                                                                                                                                                                                                       |                                                                                                                                                                                                                                          |
...
|                                                                             |                                                                                                                                                                                                                       |                                                                                                                                                                                                                                          |
| De Productie is afgerond, er is een complete levering                       | **Productie**:<br>zelfde als boven;<br>De `giAanvraagStatus` is in dit geval "https://api.klic.kadaster.nl/waardelijsten/v2/giAanvraagStatussen/giLeveringSamengesteldCompleet"                                             | **Productie**:<br>Http code 200, lijst met leveringen. De levering heeft bij `indicatieLeveringCompleet` de waarde `true`                                                                                                                      |
|                                                                             |                                                                                                                                                                                                                       |                                                                                                                                                                                                                                          |
| Er is een deel levering.                                                    | **Productie**:<br>zelfde als boven;<br>De `giAanvraagStatus` is in dit geval "https://api.klic.kadaster.nl/waardelijsten/v2/giAanvraagStatussen/giLeveringSamengesteldIncompleet"                                           | **Productie**:<br>Http code 200, lijst met leveringen. <br>De levering heeft bij `indicatieLeveringCompleet` de waarde `false`                                                                                                                    |
|                                                                             |                                                                                                                                                                                                                       |                                                                                                                                                                                                                                          |
| Na de deel levering volgt een complete levering                             | **Productie**:<br>zelfde als boven;<br>De `giAanvraagStatus` is in dit geval "https://api.klic.kadaster.nl/waardelijsten/v2/giAanvraagStatussen/giLeveringSamengesteldCompleet"                                             | **Productie**:<br>Http code 200, lijst met leveringen. <br>Er zijn meerdere leveringen met een oplopend `leveringsvolgnummer`. De levering met het hoogste volgnummer heeft bij `indicatieLeveringCompleet` de waarde `true`. De andere hebben de waarde `false`. |
|                                                                             |                                                                                                                                                                                                                       |                                                                                                                                                                                                                                          |
| Veiligheidsgebied beheerder geraakt                                         | **Productie**:<br>zelfde als boven;<br>De `giAanvraagStatus` is in dit geval "https://api.klic.kadaster.nl/waardelijsten/v2/giAanvraagStatussen/giLeveringSamengesteldCompleet"                                             | **Productie**:<br>Http code 200, lijst met leveringen. <br>Het veld `isVeiligheidsgebiedGeraakt` heeft de waarde `true`.<br>De velden `datumLeveringSamengesteld`, `indicatieLeveringCompleet` en `giLeveringUrl` zijn niet aanwezig.<br>Voor deze KLIC melding dient dan het reguliere proces waarbij er contact gezocht moet worden met de veilgheidsgebied beheerder gevolgd te worden. |
