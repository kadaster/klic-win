...
Om documenten aan te kunnen leveren zijn er bepaalde rechten nodig. Dit document gaat uit van een aanlevering van documenten in de NTD omgeving. De sectie [Mijn kadaster](readme.md#mijn-kadaster) beschrijft de benodigde rechten en hoe gecontroleerd kan worden of de gebruiker over de juiste rechten beschikt.
...
-   [Authenticatie](./readme.md#authenticatie)
-   [Netbeheerders en serviceproviders](#netbeheerders-en-serviceproviders)
-   [Endpoints](#endpoints)
-   [Documenten aanleveren](#documenten-aanleveren)
    -   [Aanlevering aanmelden](#aanlevering-aanmelden)
...
De documentatie van de API's voor het geautomatiseerd aanleveren van documenten is te vinden in de "KLIC API documentatie"-applicatie (<https://service10.kadaster.nl/klic/ntd/actualiseren/api-docs/>). Zie [API documentatie](./readme.md#api-documentatie) voor een beschrijving van deze applicatie. Voor het actualiseren van documenten worden er twee API's gebruikt; "Aanleveringen" en "Upload servlet". Voor de "Documentenbeheer" API zijn al deze endpoints meteen uit te proberen via de aangeboden interface. Voor de "Upload servlet" API is de PUT operatie niet uit te voeren vanuit de browser.

In dit voorbeeld wordt een bestand aangeleverd voor de netbeheerder "Kadaster KLIC-WIN" met de bronhouder "KL9999". Voor het aanleveren van documenten worden voornamelijk operaties gebruikt van de "Documentenbeheer" API, behalve voor het versturen van data van het aan te leveren bestand. In dat geval wordt er gebruik gemaakt van de "Upload servlet" API.
...
**Request**
```sh
curl https://service10.kadaster.nl/klic/ntd/actualiseren/documenten/backend/rest/aanleveringen/documenten/a77aff2b-c794-4ad3-a021-7c1a29096770/netbeheerder
--cookie "KadasterTicketId=54f1278c8ed9ba7d50ce6e0ecdb8fd7e"
```
