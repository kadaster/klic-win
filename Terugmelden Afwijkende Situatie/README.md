...
https://formulieren.kadaster.nl/aanvragen_api_key_terugmelding_api


### Specifieke afspraken voor terugmeldingen die betrekking hebben op de kabel en leiding informatie:


| Velden             | beschrijving/vulling                                                                                                                                                                                  | in geval van `afwijkende ligging` | in geval van `onbekend net`                               | 
|--------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------|-----------------------------------------------------------|
| coordinates        | een coördinaat in RD formaat in de buurt van de terugmelding                                                                                                                                          | verplicht                         | verplicht                                                 |
| registratie        | altijd `KLIC` voor terugmeldingen die betrekking hebben op afwijkende situaties  van Kabels en/of Leiding                                                                                             | verplicht                         | verplicht                                                 |
| bron               | hiermee geeft u de naam van de applicatie op van waaruit de melding aangemaakt wordt.                                                                                                                 | verplicht                         | verplicht                                                 |
| situatie           | er zijn twee opties: `afwijkende ligging` en `onbekend net`                                                                                                                                           | verplicht: `afwijkende ligging`   | verplicht: `onbekend net`                                 |
| klicmeldnummer     | het nummer waarop de terugmelding betrekking heeft                                                                                                                                                    | verplicht                         | verplicht                                                 |
| objectId           | hier behoort het GML-id van de kabel/leiding waarop de terugmelding betrekking heeft                                                                                                                  | verplicht                         | niet van toepassing                                       |
| objectType         | hier behoort het feature type (zoals genoemd in de klic-melding) van de kabel/leiding waarop de terugmelding betrekking heeft                                                                         | verplicht                         | niet van toepassing                                       |
| netbeheerder       | hier behoort de bronhoudercode of de naam op exact de manier waarop die ook in de KLIC-melding genoemd wordt.                                                                                         | verplicht                         | optioneel: het betreft dan een "vermoedelijke bronhouder" |
| thema              | hier behoort het thema (zoals genoemd in de klic-melding) van de kabel/leiding waarop de terugmelding betrekking heeft. Let op: het formaat moet een URI zijn zoals in het IMKL gebruikt wordt.       | verplicht                         | optioneel: het betreft dan een "vermoedelijk thema"       |
| omschrijving       | omschrijving van de afwijkende ligging. Hier kan kan ook kleur, materiaal diameter etc. in het geval van een `onbekend net`                                                                           | verplicht                         | verplicht (denk aan kleur, materiaal, diameter, etc.)     |
| terugmelder        | de naam van de terugmelder                                                                                                                                                                            | verplicht                         | verplicht                                                 |
| bedrijfsnaam       | eventueel bedrijfsnaam waarvoor de terugmelder werkt                                                                                                                                                  | optioneel                         | optioneel                                                 |
| email              | emailadres van de terugmelder, voor bevestigingsmail van de terugmelding en waarmee  de netbeheerder eventueel contact kan opnemen.                                                                   | verplicht                         | verplicht                                                 |
| telefoonnummer     | telefoonnummer van de terugmelder, zodat de netbeheerder eventueel contact kan opnemen.                                                                                                               | optioneel                         | optioneel                                                 |
| referentie         | hier kan optioneel een referentie opgegeven worden waarmee de voortgang van deze terugmelding voor de terugmelder (of terugmelder app) te volgen is                                                   | optioneel                         | optioneel                                                 |
| getekendeGeometrie | In GEOJSON formaat (inclusief type) de coördinaten in RD formaat in de buurt van de terugmelding. Kan gebruikt worden als de terugmelder in de app bijvoorbeeld de werkelijke ligging getekend heeft. | optioneel                         | optioneel                                                 |


:triangular_flag_on_post: Bij de situatie van `niet gevonden net` is de ondersteuning in de API uitgefaseerd.  \
De grondroerder dient direct contact op te nemen met de netbeheerder.
	...
	"features": [
		{
			...
			"properties": {
				...
				"situatie": "afwijkende ligging",                           // er zijn twee opties: `afwijkende ligging` en `onbekend net`
